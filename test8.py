...
def draw_images():
    ...
    game_objects["base1"] = c.create_image(0, 670, image=images["base"], anchor=NW)
    ...
    game_objects["cannon_green"] = c.create_image(40, 560, image=images["cannon_create_green"], anchor=NW)
    game_objects["cannon_blue"] = c.create_image(400, 560, image=images["cannon_create_blue"], anchor=NW)
    game_objects["cannon_red"] = c.create_image(860, 560, image=images["cannon_create_red"], anchor=NW)
    game_objects["selected1"] = c.create_image(40, 560, image=images["select_green_cannon"], anchor=NW)
    game_objects["selected2"] = c.create_image(400, 560, image=images["select_blue_cannon"], anchor=NW)
    game_objects["selected3"] = c.create_image(860, 555, image=images["select_red_cannon"], anchor=NW)
